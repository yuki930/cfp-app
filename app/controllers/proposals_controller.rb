class ProposalsController < ApplicationController
  ...
  def create
    ...
    if @proposal.save
      ...
      Net::HTTP.post_form URI('https://idobata.io/hook/custom/348d8cbd-83c5-486e-952b-45a679f152e5'), format: 'html', source: %(#{current_user.name} submitted <a href="#{reviewer_event_proposal_url @event, @proposal}">a new proposal</a>!)
